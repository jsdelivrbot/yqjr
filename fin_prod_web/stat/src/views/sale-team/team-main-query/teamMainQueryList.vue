            ...
            <Card>
                ...
                <Form ref="formValidate" :model="searchFormDate" :label-width="100">
                    ...
                    <Row>
                        <Col span="8" offset="2">
                            <FormItem label="团队级别:">
                                <Select v-model="searchFormDate.teamLevel" style="width:100%" placeholder = "全部">
                        ...
                        <Col span="8" offset="2">
                            <FormItem label="有效状态:">
                                <Select v-model="searchFormDate.teamStatus" style="width:100%" placeholder = "全部">
                                    <Option value="" selected>全部</Option>
...
export default{
                    ...
                    render: (h, params) => {
                        return h('div', [
                            h('Button', {
                                ...
                                on: {
                                    click: () => {
                                        let routerParam = {id: params.row.id, teamCode: params.row.teamCode, tabName: 'name1'};
                                        this.$router.push({
    ...
    computed: {
        ...mapState({
            loading: ({teamMainList}) => teamMainList.loading,
            tableData: ({teamMainList}) => teamMainList.teamMainQueryList,
            pageNo: ({teamMainList}) => teamMainList.pageNo,
            pageSize: ({teamMainList}) => teamMainList.pageSize,
            total: ({teamMainList}) => teamMainList.total,
            pages: ({teamMainList}) => teamMainList.pages
        })
    },
    methods: {
        ...mapActions([
