...
/**
 * <p>fyzlDynamicBillMainVO complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="fyzlDynamicBillMainVO"&gt;
 *   &lt;complexContent&gt;
 *     &lt;extension base="{http://service.fyzldynamicbillservice.server.charge.yqjr.webservice.cc.epoch.com/}requestCommon"&gt;
 *       &lt;sequence&gt;
...
@XmlType(name = "fyzlDynamicBillMainVO", propOrder = {
    "attachmentCount",
    "businessCode",
    "memo",
    "memo1",
...
public class FyzlDynamicBillMainVO
