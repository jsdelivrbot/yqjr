...
//       areaCode = user.getAreaCode();
    ...
    public ResultMsg<PersonMainReview> audit(HttpServletRequest request, Model model) {
        try{
            ...
            Long personTeamReviewId = Long.valueOf(request.getParameter("personTeamReviewId"));
            ...
            personMainReviewService.personAudit(personCode,workid,reviewStatus,opinion,personTeamReviewId);
...
//    })
    ...
    @RequestMapping(value = "/reviewwatch", method = RequestMethod.GET)
    @ResponseBody
    public ResultMsg<PersonMainReviewVo> reviewWatch( @RequestParam(value = "personTeamReviewId") Long personTeamReviewId) {
        try{
            PersonMainReviewVo personMainReviewVos = personMainReviewService.reviewWatch(personTeamReviewId);
            return new ResultMsg<PersonMainReviewVo>(Const.MSG_CHECK_SUCCESS, null,Const.SUCCESS,  personMainReviewVos);
        }catch (ValidationException e){
            e.printStackTrace();
            return new ResultMsg<PersonMainReviewVo>( Const.MSG_CHECK_FAILURE, "操作失败" ,Const.FAILURE, null);
        }catch (Exception e) {
    ...
    @ResponseBody
    public ResultMsg<PersonDetail> processModifySubmit(@RequestBody PersonDetail personDetail){
       try{
            personMainReviewService.updatePersonInfo(personDetail);
