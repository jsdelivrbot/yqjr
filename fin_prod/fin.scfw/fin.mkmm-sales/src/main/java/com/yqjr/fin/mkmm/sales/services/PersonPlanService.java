...
public class PersonPlanService extends BaseService<PersonPlanMapper, PersonPlan, Long> {
    ...
    public void downloadExl(HttpServletResponse response) throws IOException {
        ...
        //表头
        List<SelectCodeVo> brandsList = getBrandsList();
        String [] cellValues = {"姓名","人员代码","一月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","十二月" };
        String [] sheetNames = new String[brandsList.size()];
        for (int i=0;i<brandsList.size();i++) {
            sheetNames[i] = brandsList.get(i).getLabel();
        }
    ...
    public void readPlanExl(InputStream inputStream,String company) throws Exception {
        ...
        //创建品牌list
        List<SelectCodeVo> brands = getBrandsList();
        List<String> brandsList = new ArrayList<String>();
        for(int b=0;b<brands.size();b++) {
            brandsList.add(brands.get(b).getValue());
            System.out.println(brands.get(b).getValue());
        }
        for (int i=0;i<book.getNumberOfSheets(); i++) {
            ...
            if(clos !=14 ) {
                throw new ValidationException("导入数据有误！请检查！");
            }
    ...
    public void updateTables(String personCode,List<String> brandsList,int i,String year,String company) throws ParseException {
        ...
        for(int j=0;j<brandsList.size();j++) {
            ...
            pMain.setPersonCode(personCode);
            pMain.setCompany(company);
            List<PersonMain> pms = personMainService.selectPersonMainByCode(pMain);
            String personName = "";
            if(pms.size()>0) {
                personName = pms.get(0).getPersonName();
            }
            //查这个人的性质和区域
            ...
            if (personTeams.size()>0) {
                ...
                String teamCode = personTeams.get(0).getTeamCode();
                String teamName = personTeams.get(0).getTeamName();
                ptr.setAreaCode(areaCode);
                ptr.setAreaName(areaName);
                ptr.setPersonType(personNature);
                ptr.setTeamCode(teamCode);
                ptr.setTeamName(teamName);
            }
            ptr.setYear(year);
            ...
            ptr.setBrands(brands);
            ptr.setPersonCode(personCode);
            ptr.setPersonName(personName);
    ...
    //查询年计划
    @Transactional
    public JQGridJsonResult<PersonPlanVo> queryPersonPlan(PersonPlanCondition condition, PageBounds... pageBounds){
        //查询条件年份
        ...
        //set值
        List<PersonPlan> personPlans = saveData(year,brands,voList,company, pageBounds);
        //处理分页
        JQGridJsonResult<PersonPlanVo> jqGridJson = doJQGridJsonResult(voList, personPlans);
        return jqGridJson;
    }

    //处理分页
    public JQGridJsonResult<PersonPlanVo> doJQGridJsonResult (List<PersonPlanVo> voList, List<PersonPlan> personPlans) {
        PageInfo<PersonPlan> pageList = new PageInfo<>(personPlans);
        ...
        jqGridJson.setRows(voList);
        return jqGridJson;
    }


    //set值
    public List<PersonPlan> saveData(String year,String brands,List<PersonPlanVo> voList,String company, PageBounds... pageBounds){
        //查人的集合,去重
        PersonPlanCondition personPlanCondition = new PersonPlanCondition();
        personPlanCondition.setCompany(company);
        personPlanCondition.setBrands(brands);
        personPlanCondition.setYear(year);
        List<PersonPlan> personPlans = personPlanMapper.selectPersonPlan(personPlanCondition, pageBounds);
    ...
    public void exportPlan(HttpServletResponse response, String year,String company) throws Exception {
        ...
        String [] cellValues = {"姓名","人员代码","一月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","十二月" };
        String [] sheetNames = new String[brandsList.size()];
        String [] brandNames = new String[brandsList.size()];
        for (int i=0;i<brandsList.size();i++) {
            sheetNames[i] = brandsList.get(i).getLabel();
            brandNames[i] = brandsList.get(i).getValue();
        }
        //插入数据
    ...
    public void queryPlan(String year,String[] brandNames,HSSFWorkbook workbook,String [] cellValues,String [] sheetNames,String  company){
        for(int i=0;i<brandNames.length;i++) {
            ...
            personPlanCondition.setBrands(brands);
            personPlanCondition.setCompany(company);
            List<PersonPlan> personPlans = personPlanMapper.selectPersonPlan(personPlanCondition);
            //写计划
    ...
    public void writeJanuary(String year, String brands, String personCode,String company,HSSFRow row){
        PersonPlan pp1 = new PersonPlan();
        pp1.setCompany(company);
        pp1.setPersonCode(personCode);
        pp1.setBrands(brands);
        pp1.setYear(year);
        pp1.setMonth("1");
        List<PersonPlan> pp = personPlanMapper.selectPersonMonthPlan(pp1);
    ...
    public void writeFebruary(String year, String brands, String personCode,String company,HSSFRow row){
        PersonPlan pp2 = new PersonPlan();
        pp2.setCompany(company);
        pp2.setPersonCode(personCode);
        pp2.setBrands(brands);
        pp2.setYear(year);
        pp2.setMonth("2");
        List<PersonPlan> pp = personPlanMapper.selectPersonMonthPlan(pp2);
        if(pp.size()>0) {
    ...
    public void writeMarch(String year, String brands, String personCode,String company,HSSFRow row){
        PersonPlan pp3 = new PersonPlan();
        pp3.setCompany(company);
        pp3.setPersonCode(personCode);
        pp3.setBrands(brands);
        pp3.setYear(year);
        pp3.setMonth("3");
        List<PersonPlan> pp = personPlanMapper.selectPersonMonthPlan(pp3);
        if(pp.size()>0) {
    ...
    public void writeApril(String year, String brands, String personCode,String company,HSSFRow row){
        PersonPlan pp4 = new PersonPlan();
        pp4.setCompany(company);
        pp4.setPersonCode(personCode);
        pp4.setBrands(brands);
        pp4.setYear(year);
        pp4.setMonth("4");
        List<PersonPlan> pp = personPlanMapper.selectPersonMonthPlan(pp4);
        if(pp.size()>0) {
    ...
    public void writeMay(String year, String brands, String personCode,String company,HSSFRow row){
        PersonPlan pp5 = new PersonPlan();
        pp5.setCompany(company);
        pp5.setPersonCode(personCode);
        pp5.setBrands(brands);
        pp5.setYear(year);
        pp5.setMonth("5");
        List<PersonPlan> pp = personPlanMapper.selectPersonMonthPlan(pp5);
        if(pp.size()>0) {
    ...
    public void writeJune(String year, String brands, String personCode,String company,HSSFRow row){
        PersonPlan pp6 = new PersonPlan();
        pp6.setCompany(company);
        pp6.setPersonCode(personCode);
        pp6.setBrands(brands);
        pp6.setYear(year);
        pp6.setMonth("6");
        List<PersonPlan> pp = personPlanMapper.selectPersonMonthPlan(pp6);
        if(pp.size()>0) {
    ...
    public void writeJule(String year, String brands, String personCode,String company,HSSFRow row){
        PersonPlan pp7 = new PersonPlan();
        pp7.setCompany(company);
        pp7.setPersonCode(personCode);
        pp7.setBrands(brands);
        pp7.setYear(year);
        pp7.setMonth("7");
        List<PersonPlan> pp = personPlanMapper.selectPersonMonthPlan(pp7);
        if(pp.size()>0) {
    ...
    public void writeAugust(String year, String brands, String personCode,String company,HSSFRow row){
        PersonPlan pp8 = new PersonPlan();
        pp8.setCompany(company);
        pp8.setPersonCode(personCode);
        pp8.setBrands(brands);
        pp8.setYear(year);
        pp8.setMonth("8");
        List<PersonPlan> pp = personPlanMapper.selectPersonMonthPlan(pp8);
        if(pp.size()>0) {
    ...
    public void writeSeptember(String year, String brands, String personCode,String company,HSSFRow row){
        PersonPlan pp9 = new PersonPlan();
        pp9.setCompany(company);
        pp9.setPersonCode(personCode);
        pp9.setBrands(brands);
        pp9.setYear(year);
        pp9.setMonth("9");
        List<PersonPlan> pp = personPlanMapper.selectPersonMonthPlan(pp9);
        if(pp.size()>0) {
    ...
    public void writeOctober(String year, String brands, String personCode,String company,HSSFRow row){
        PersonPlan pp10 = new PersonPlan();
        pp10.setCompany(company);
        pp10.setPersonCode(personCode);
        pp10.setBrands(brands);
        pp10.setYear(year);
        pp10.setMonth("10");
        List<PersonPlan> pp = personPlanMapper.selectPersonMonthPlan(pp10);
        if(pp.size()>0) {
    ...
    public void writeNovember(String year, String brands, String personCode,String company,HSSFRow row){
        PersonPlan pp11 = new PersonPlan();
        pp11.setCompany(company);
        pp11.setPersonCode(personCode);
        pp11.setBrands(brands);
        pp11.setYear(year);
        pp11.setMonth("11");
        List<PersonPlan> pp = personPlanMapper.selectPersonMonthPlan(pp11);
        if(pp.size()>0) {
    ...
    public void writeDecember(String year, String brands, String personCode,String company,HSSFRow row){
        PersonPlan pp12 = new PersonPlan();
        pp12.setCompany(company);
        pp12.setPersonCode(personCode);
        pp12.setBrands(brands);
        pp12.setYear(year);
        pp12.setMonth("12");
        List<PersonPlan> pp = personPlanMapper.selectPersonMonthPlan(pp12);
        if(pp.size()>0) {
     ...
     * 查询品牌方法
     */
    public List<SelectCodeVo> getBrandsList() {
        List<SelectCodeVo> brandsList = metaGateway.transCode("CarBrand","0","");
        return brandsList;
    }
