...
public class SessionFilter implements Filter {
	...
	private static final Set<String> ALLOWED_PATHS = Collections
			.unmodifiableSet(new HashSet<>(Arrays.asList("/activeTimedTask/build","/basicBussinesss/dataProcess","/activeTimedTask/match","/planTrackTimedTask/build",
                                                        "/planTrackTimedTask/track","/EffectiveChanges/changePersonStatus")));
