 ...
 */
package com.yqjr.scfw.common.excel.bean;

import com.yqjr.scfw.common.excel.annotation.ExcelColumnGroup;
import com.yqjr.scfw.common.excel.annotation.output.OutputTargetConfig;
...
public class DataBean {
    ...
    public DataBean(Class excelVo, Class inputAdapter, Class outputAdapter, Class validateAdapter) throws Exception {
        this(Reflections.getAllFields(excelVo, BaseExcelVo.class), inputAdapter, outputAdapter, validateAdapter);
    }

    public DataBean(List<Field> filedList, Class inputAdapter, Class outputAdapter, Class validateAdapter) throws Exception {
    ...
    public Object getFieldValue(String fieldName, Object excelVo) throws AdapterException {
        ...
        try {
            ...
            throw new AdapterException(fieldName, Message.FIELD_GET_ERROR,e);
        }
    }
    public void setTargetFieldValue(String fieldName, Object excelVo, Object value)throws AdapterException{
        ...
        if (value!=null){
            try {
                ...
                throw new AdapterException(fieldName, Message.FIELD_SET_ERROR,e);
            }
        }
    }
    ...
    public void setFieldValue(String fieldName, Object excelVo, Object value) throws AdapterException {
        ...
        if (fieldBean.isDefaultByUp()) {
            if (value==null) {
                fieldBean.setLastValue(null);
            } else {
                value = fieldBean.getLastValue();
            }
        }
        if(value instanceof String&& ObjectHelper.isNullOrEmptyString(value)&&!fieldBean.isNullAble()){
            throw new AdapterException(fieldName, Message.FIELD_NULL_ERROR);
        }else if(value!=null){
            try {
                if (useGetterSetter) {
    ...
    public String[] getFiledNames() {
        if (filedNames == null)return null;
        return filedNames.clone();
    }
