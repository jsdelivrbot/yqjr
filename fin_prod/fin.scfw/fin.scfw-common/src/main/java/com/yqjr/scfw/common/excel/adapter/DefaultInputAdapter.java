...
import com.yqjr.scfw.common.excel.annotation.input.InputDateConfig;
import com.yqjr.scfw.common.excel.annotation.input.InputDicConfig;
import com.yqjr.scfw.common.excel.annotation.input.InputIntConfig;
import com.yqjr.scfw.common.excel.annotation.input.InputTextConfig;
import com.yqjr.scfw.common.excel.annotation.output.OutputDateConfig;
...
public class DefaultInputAdapter extends IOAdapter {
     ...
     * @throws IllegalAccessException
     */
    public Object inputDicCodeAdapter(DataBean dataBean, Class type, String fieldName, Cell cell) throws Exception {
        ...
        if(CellType.BLANK==cell.getCellTypeEnum()){
            ...
            if (CellType.NUMERIC == cell.getCellTypeEnum()) {
                ...
                try { //日期格式也是数字格式这里判断用户输入的到底是不是2014026这种格式
                    ...
                    throw new AdapterException(fieldName, Message.DATE_TYPE_ERROR,cell,e);
                }
...
//            }
            ...
            throw new AdapterException(Message.INPUT_CELL_DATA_ERROR, cell,e);
        }
