...
public class MaterialOutRest extends BaseRest<MaterialOutService, MaterialOut> {
    ...
    public ObjectResultResponse MaterialOutToSave(@RequestBody MaterialOutVo condition) {
        try{
            ...
            return this.getObjectResultResponse(Const.SUCCESS,Const.CODE_SUCCESS,Const.MSG_PUSH_SUCCESS,null);
...
//            @RequestBody MaterialInVo condition,
    ...
    public ObjectResultResponse receiveButton(@RequestBody MaterialOut materialOut) {
        try {
            materialDealerService.update(materialOut);
