...
public class ActiveMarketingReviewCondition extends BaseCondition<ActiveMarketingReview, Long> {
    ...
    /**
     *
     *列表查询页面：/activeMarketingReview/list
     *表单维护路径：/activeMarketingReview/form
     *
     */
