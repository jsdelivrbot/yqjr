...
public class ProductCodeCondition extends BaseCondition<ProductCode, Long> {
    ...
    /**
     * 产品类型（INTEREST_TYPE-信贷产品，PD_DLRBIZTYPE-金融产品，PD_BIZTYPE-业务类型，EXTRACHARGE_LIST-附加贷）
     */
    @Length(min = 0, max = 64)
