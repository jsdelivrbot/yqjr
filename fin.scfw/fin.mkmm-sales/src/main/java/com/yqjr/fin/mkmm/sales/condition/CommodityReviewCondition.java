...
public class CommodityReviewCondition extends BaseCondition<CommodityReview, Long> {
    ...
    public Long getPutUnivalent() {
        return this.putUnivalent;
    }

    public void setPutUnivalent(Long putUnivalent) {
