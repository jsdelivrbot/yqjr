 ...
 */
package com.yqjr.scfw.common.excel.adapter;

import com.yqjr.scfw.common.excel.annotation.validate.*;
import com.yqjr.scfw.common.excel.bean.DataBean;
import com.yqjr.scfw.common.excel.language.LanguageUtils;
import com.yqjr.scfw.common.excel.service.BaseExcelService;
import com.yqjr.scfw.common.excel.utils.AdapterUtil;
import com.yqjr.scfw.common.excel.utils.DicCodePool;
import com.yqjr.scfw.common.excel.utils.Message;
...
public class DefaultValidateAdapter extends IOAdapter{
     ...
     * @param filedName
     */
    public void DicCodeValidateAdapter(DataBean dataBean, Sheet sheet, int columnIndex, String filedName) throws Exception {
     ...
     * @param config
     */
    protected void  setValidationTip(DataValidation validation,Annotation config) throws Exception {
     ...
     * @param valueSet
     */
    protected void createDicCodeSheet(DicValidateConfig config,Sheet sheet,int columnIndex,Set<String> valueSet) throws Exception {
     ...
     * @param filedName
     */
    public void DateValidateAdapter(DataBean dataBean, Sheet sheet, int columnIndex, String filedName) throws Exception {
     ...
     * @param filedName
     */
    public void NumericValidateAdapter(DataBean dataBean, Sheet sheet, int columnIndex, String filedName) throws Exception {
     ...
     * @param filedName
     */
    public void IntegerValidateAdapter(DataBean dataBean, Sheet sheet, int columnIndex, String filedName) throws Exception {
     ...
     * @param filedName
     */
    public void TextValidateAdapter(DataBean dataBean, Sheet sheet, int columnIndex, String filedName) throws Exception {
