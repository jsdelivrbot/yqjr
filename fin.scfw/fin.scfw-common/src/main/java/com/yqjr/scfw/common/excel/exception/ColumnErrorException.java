...
public class ColumnErrorException extends Exception {
    ...
    public ColumnErrorException(int row, int clo, String message,Throwable cause) {
        super(message,cause);
        this.row = row;
        this.clo = clo;
        this.message = LanguageUtils.translate(message,row,clo);
    ...
    public ColumnErrorException(int row, String fieldName, String message,Throwable cause) {
        super(message,cause);
        this.row = row;
