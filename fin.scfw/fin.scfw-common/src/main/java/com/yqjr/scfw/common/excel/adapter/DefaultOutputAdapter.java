...
import com.yqjr.scfw.common.excel.annotation.output.OutputDicConfig;
import com.yqjr.scfw.common.excel.annotation.output.OutputNumericConfig;
...
public class DefaultOutputAdapter extends IOAdapter {
     ...
     */
    public void outputDicCodeAdapter(DataBean dataBean, Object fieldValue, String fieldName, Cell cell) throws Exception {
