...
export default {
    ...
    data () {
        ...
        if(this.$route.name==='work_iframe'){
            routeName=this.$route.params.pathName;
        }
        return {
    ...
    methods: {
        ...
        linkTo (item) {
            ...
            this.$store.state.app.menuList.forEach(menu =>{
                if(menu.children.length===1&&(menu.name==item.name)){
                    isfream=true
                }else{
            ...
            if (this.beforePush(item)) {
                if (isfream) {
                    this.$router.push({name: "work_iframe",params: {pathName:item.name}});
                }else{
    ...
    watch: {
        '$route' (to) {
            if(to.name==='work_iframe'){
                this.currentPageName=to.params.pathName;
            }else{
