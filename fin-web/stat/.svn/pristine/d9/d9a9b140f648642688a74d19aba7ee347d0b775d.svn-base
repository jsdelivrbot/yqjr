                    ...
                    <Row>
                        <Col span="8" offset="2">
                            <FormItem label="年份:" prop="year" >
                                <DatePicker type="year" @on-change="getYear" style="width: 100%" placeholder="请输入年份" v-bind:clearable="false" v-bind:editable="false"></DatePicker>
                            </FormItem>
                        </Col>
