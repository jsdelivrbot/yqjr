            ...
            <Card class="margin-top-10">
                ...
                <Row>
                    ...
                    <FormItem label="人员性质：" prop="personNature">
                        <i-select v-model="searchPersonData.personNature" style="width:220px">
                    ...
                    <FormItem label="人员级别："  prop="personNature">
                        <i-select v-model="searchPersonData.personLevel" style="width:220px">
                ...
                <Row>
                    ...
                    <FormItem label="人员状态：" prop="personStatus">
                        <i-select v-model="searchPersonData.personStatus" disabled style="width:220px">
                    ...
                    <FormItem label="考核开始时间：" prop="personCheckStart">
                        <DatePicker type="date" v-model="searchPersonData.personCheckStart" placeholder="请选择开始时间" style="width: 220px"></DatePicker>
                    </FormItem>
                    </Col>
                </Row>
                <Row>
                    ...
                    <FormItem label="上岗日期："  prop="personUptime">
                        <DatePicker type="date" v-model="searchPersonData.personUptime" placeholder="请选择上岗日期" style="width: 220px"></DatePicker>
                    </FormItem>
                    </Col>
                    <Col span="8" offset="2">
                    <FormItem label="转正日期：" prop="personCorrectime">
                        <DatePicker type="date" v-model="searchPersonData.personCorrectime" placeholder="请选择转正日期" style="width: 220px"></DatePicker>
                    </FormItem>
                    </Col>
                </Row>
                <Row>
                    ...
                    <FormItem label="试用期开始日期：" prop="personTryStartime">
                        <DatePicker type="date" v-model="searchPersonData.personTryStartime" placeholder="请选择使用期开始日期" style="width: 220px"></DatePicker>
                    </FormItem>
                    </Col>
                    <Col span="8" offset="2">
                    <FormItem label="试用期结束日期："  prop="personTryEndtime">
                        <DatePicker type="date" v-model="searchPersonData.personTryEndtime" placeholder="请选择试用期结束日期" style="width: 220px"></DatePicker>
                    </FormItem>
                    </Col>
                </Row>
                <Row>
                    ...
                    <FormItem label="加入我司日期：" prop="personJointime">
                        <DatePicker type="date"  v-model="searchPersonData.personJointime" placeholder="请选择加入我司日期" style="width: 220px"></DatePicker>
                    </FormItem>
                    </Col>
                    <Col span="8" offset="2">
                    <FormItem label="生效日期："  prop="startTime">
                        <DatePicker type="date"  v-model="searchPersonData.startTime" placeholder="请选择生效日期" style="width: 220px"></DatePicker>
                    </FormItem>
                    </Col>
                </Row>
                <Row>
                    <Col span="8" offset="2">
                    <FormItem label="负责省份："  >
                        <Select   v-model="searchPersonData.provinces"  filterable multiple  :loading="loading" @on-change='getCityList' style="width: 650px">
                ...
                <Row>
                    <Col span="8" offset="2">
                    <FormItem label="负责城市：" >
                        <Select  v-model="searchPersonData.cities"  :label-in-value="true" filterable multiple  @on-change='getCityArr'  :loading="loading"  style="width: 650px">
                ...
                <Row>
                    <Col span="8" offset="2">
                    <FormItem label="负责品牌：" >
                        <Select  v-model="searchPersonData.brands" :label-in-value="true"  filterable multiple  :loading="loading" style="width: 650px">
            ...
            <Card class="margin-top-10">
                ...
                <Row>
                    ...
                    <FormItem label="备注："  prop="remark">
                        <Input  v-model="searchPersonData.remark" type="textarea" :autosize="{minRows: 2,maxRows: 2}" style="width:650px"></Input>
                    </FormItem>
                    </Col>
                </Row>
                <Row>
