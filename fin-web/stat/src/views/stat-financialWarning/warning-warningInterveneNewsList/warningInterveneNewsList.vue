            ...
            <Card>
                ...
                <Form ref="formValidate" :rules="ruleValidate" :model="searchFormDate" :label-width="100">
                    <Row >
                        <Col span="8" offset="2">
                            <FormItem label="预警起期：">
                                <DatePicker type="date" :value="searchFormDate.starDate4" style="width: 100%"
                                            format="yyyy-MM-dd"
                        ...
                        <Col span="8" offset="2">
                            <FormItem label="预警止期：">
                                <DatePicker type="date"  :value="searchFormDate.endDate4" style="width: 100%"
    ...
    export default {
        ...
        methods: {
            ...
            init () {
                ...
                if (roleCode.indexOf('0009') >= 0 || roleCode.indexOf('0003') >= 0) {
