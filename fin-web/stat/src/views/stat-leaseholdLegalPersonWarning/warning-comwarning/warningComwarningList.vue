            ...
            <Card>
                ...
                <Form ref="formValidate" :rules="ruleValidate" :model="searchFormDate" :label-width="100">
                    <Row v-show="showFlag.areaFlag">
                        <Col span="8" offset="2">
                            <FormItem label="预警起期：">
                                <DatePicker type="date" :value="searchFormDate.starDate2" style="width: 100%"
                                            format="yyyy-MM-dd"
                        ...
                        <Col span="8" offset="2">
                            <FormItem label="预警止期：">
                                <DatePicker type="date"  :value="searchFormDate.endDate2" style="width: 100%"
    ...
    export default {
        ...
        methods: {
            ...
            chuShi () {
                ...
                this.searchFormDate.chandlestate = '0,1,2,3,4,5,6';
