import {apiTeamMainQueryList, genJuZhiBiaoChaMingZiLuJing, chaXun, apiIName, apiMany, apiExcel} from '../../../../api/stat-warning/warning-warningAuditing/warningAuditingApi.js';
import config from '@/config';

const warningAuditingList = {
    state: {
        teamMainQueryList: [],
        zhiBiaoQueryList: [],
        manyData: [],
...
export default warningAuditingList;
