...
<script>
    ...
    export default{
        ...
        methods: {
            ...mapActions([
                'handleTeamList2', 'handleDelTeamList2', 'handleIndicatorTypes2'
            ]),
            /**
             * 初始化
             */
            ...
            searchIndicatorTypes () {
                this.handleIndicatorTypes2(this.searchFormDate).then(res => {
                    resetWorkHeight();
             ...
             */
            searchData () {
                this.handleTeamList2(this.searchFormDate).then(res => {
                    resetWorkHeight();
                    this.$Message.info('查询成功!');
                });
            },
            ...
            delData () {
                if (isEmpty(this.idArr)) {
                    ...
                    this.$Modal.confirm({
                        ...
                        onOk: () => {
                            this.handleDelTeamList2(this.idArr).then(res => {
             ...
             */
            editData () {
                this.$router.push({name: 'teamEdit'});
            },
            /**
             * 查看数据
             */
            viewData () {
                this.$router.push({name: 'teamView'});
            }
        },
        mounted () {
            this.init();
