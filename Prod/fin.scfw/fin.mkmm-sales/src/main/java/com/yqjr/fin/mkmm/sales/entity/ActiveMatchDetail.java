...
public class ActiveMatchDetail extends BaseEntity<ActiveMatchDetail> {
    ...
    public BigDecimal getNloanMoney() { return nloanMoney; }

    public void setNloanMoney(BigDecimal nloanMoney) { this.nloanMoney = nloanMoney; }

    public BigDecimal getNecloanMoney() { return necloanMoney; }

    public void setNecloanMoney(BigDecimal necloanMoney) { this.necloanMoney = necloanMoney; }

    public BigDecimal getFirstRatio() { return firstRatio; }

    public void setFirstRatio(BigDecimal firstRatio) { this.firstRatio = firstRatio; }
