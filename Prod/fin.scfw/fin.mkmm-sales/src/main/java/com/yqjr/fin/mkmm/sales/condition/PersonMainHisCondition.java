...
public class PersonMainHisCondition extends BaseCondition<PersonMainHis, Long> {
    ...
    /**
     *
     *列表查询页面：/personMainHis/list
     *表单维护路径：/personMainHis/form
     *
     */
    ...
    private java.util.Date personFirstworktime;
     ...
     */
    @DateTimeFormat(pattern = "yyyy-MM-dd")
    private java.util.Date personBirth;
     ...
     */
    @Digits(fraction =22,integer=0)
    private java.lang.Long personTeamHisId;

    public Long getPersonTeamHisId() {
        return personTeamHisId;
    }

    public void setPersonTeamHisId(Long personTeamHisId) {
        this.personTeamHisId = personTeamHisId;
    }
    public Long getId() {
        return this.id;
    }
    ...
    public java.util.Date getPersonFirstworktime() {
        return this.personFirstworktime;
    }

    public void setPersonFirstworktime(java.util.Date personFirstworktime) {
    ...
    public java.util.Date getPersonBirth() {
        return this.personBirth;
    }

    public void setPersonBirth(java.util.Date personBirth) {
