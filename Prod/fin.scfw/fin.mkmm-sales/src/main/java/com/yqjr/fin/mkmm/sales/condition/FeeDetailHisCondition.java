...
public class FeeDetailHisCondition extends BaseCondition<FeeDetailHis, Long> {
    ...
    /**
     *
     *列表查询页面：/feeDetailHis/list
     *表单维护路径：/feeDetailHis/form
     *
     */
    ...
    public BigDecimal getFirstRatio() { return this.firstRatio; }
