...
public class DicCodePool {
    ...
    public void addMap(String mapName, List<Map> mapList) {
        if (ObjectHelper.isNotEmpty(mapList)) {
            Map<String, String> keyDicBeanMap = new HashMap<String, String>(mapList.size());
            Map<String, String> valueDicBeanMap = new HashMap<String, String>(mapList.size());
            Set keySet = new LinkedHashSet(mapList.size());
            Set valueSet = new LinkedHashSet(mapList.size());
    ...
    public void addMap(String mapName, Map<String, String> map) {
        if (ObjectHelper.isNotEmpty(map)) {
            Map<String, String> keyDicBeanMap = new HashMap<String, String>(map.size());
            Map<String, String> valueDicBeanMap = new HashMap<String, String>(map.size());
            Set keySet = new LinkedHashSet(map.size());
            Set valueSet = new LinkedHashSet(map.size());
