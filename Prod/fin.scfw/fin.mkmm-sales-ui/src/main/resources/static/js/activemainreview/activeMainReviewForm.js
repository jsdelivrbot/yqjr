...
$(document).ready(function () {
    ...
    var appendixId=createRandomId();//生成随机ID
    $("#additionalId").val(appendixId);
    var user = getUserCookie();
    $("#areaMainName").val(user.areaName);
    $("#areaMainCode").val(user.areaCode);
    ...
    function creactObj(){
        ...
        ativeMainObj["additionalId"]=$("#additionalId").val();                 //附件上传ID
        ...
        if(!formMainValidate(ativeObj)){ //验证主信息
            return false;
        }
