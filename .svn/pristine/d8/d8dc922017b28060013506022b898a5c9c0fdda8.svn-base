...
public class FctAltCustomService extends BaseService<FctAltCustomMapper, FctAltCustom, Long> {
    ...
    public void updateHandlestateByEventid(FctAltCustom fctAltCustom){
        System.out.println( fctAltCustom.getHandlestate());
        if(fctAltCustom.getHandlestate().equals("0"))
        {
            System.out.println("a");
            FctAltCustom f = new FctAltCustom();
            f.setEventid(fctAltCustom.getEventid());
            f.setEventstate("1");
            fctAltCustomMapper.updateeventstateByEventid(f);
        }
...
//        condition.setCompany(company);
    ...
    public List<FctAltCustom> selectFctAltCustomByChandlestate (FctAltCustomCondition condition, PageBounds of){
        return  fctAltCustomMapper.selectFctAltCustomByChandlestate(condition,of);
    }
    public void updateeventstateByEventid(FctAltCustom fctAltCustom){
         fctAltCustomMapper.updateeventstateByEventid(fctAltCustom);
    }
    public void updateModifByEventid(FctAltCustom fctAltCustom){
        fctAltCustomMapper.updateModifByEventid(fctAltCustom);
    }
}