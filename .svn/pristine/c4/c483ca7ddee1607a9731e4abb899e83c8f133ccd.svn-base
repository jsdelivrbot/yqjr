...
public class FeeDetail extends BaseEntity<FeeDetail> {
    ...
    /**
     *
     *列表查询页面：/feeDetail/list
     *表单维护路径：/feeDetail/form
     *
     */
    ...
    public Long getFirstRatio() {
        return this.firstRatio;
    }

    public void setFirstRatio(Long firstRatio) {
