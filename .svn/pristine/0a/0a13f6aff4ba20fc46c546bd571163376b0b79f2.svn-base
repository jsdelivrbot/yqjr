            ...
            if(parseInt(maxBillFee)<parseInt(billFee) || parseInt(billFee)<parseInt(0)) {
                ...
                if(!isNum.test(billFee)) {
                    ...
                    $.ajax({
                        ...
                        url: '/mkmm/sales/feeMainReviews/feeMainReviewAdd?businessCode='+businessCode,
                        ...
                        layer.alert(obj.msg,function (){
                            history.go(-1);
                            commonForward('/mkmm/ui/activeMatchMain/list');
                        });
                        // $("#inputForm").resetForm();
                    }).always(function () {
