            ...
            <Card class="margin-top-10">
                ...
                <Row>
                    ...
                    <FormItem label="审核意见：" prop="opinion">
                        <Input v-model="personReviewEditData.opinion" type="textarea" style="width: 100%" :autosize="{minRows: 2,maxRows: 6}"></Input>
                    </FormItem>
                    </Col>
                </Row>
                <Row>
    ...
    export default{
        ...
        methods: {
            ...
            getReviewStatusName (value) {
                if (value === '04') {
                    this.personReviewEditData.opinion = '同意';
                } else {
                    this.personReviewEditData.opinion = '';
                }
            },
            /**
             * 展示省市
            ...
            personReviewSub: function (name) { // 提交审核
                this.$refs[name].validate((valid) => {
                    if (valid) {
                        if (this.personReviewEditData.reviewStatus === '04') {
