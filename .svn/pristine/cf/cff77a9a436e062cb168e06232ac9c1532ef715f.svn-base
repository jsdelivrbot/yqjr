...
public class Reflections {
	...
	/**
	 * Description: 根据setter方法名获取数据名称 <br>
	 * Create By: admin <br>
	 * Create Date: 2017年5月4日 上午11:41:50
	 *
	 * @param setterMethodName
	 * @return
	 */
	public static String getFieldName(String setterMethodName) {
		return StringUtils.uncapitalize(StringUtils.removeStart(setterMethodName, SETTER_PREFIX));
	}
}
