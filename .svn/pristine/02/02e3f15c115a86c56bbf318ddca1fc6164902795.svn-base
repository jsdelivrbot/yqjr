...
@Data
@Table(name = "qcms_decision_tree_model", schema = "QCMS")
public class DecisionTreeModel extends FinBaseMapperEntity<Long> {
     ...
     */
	@Id
	@KeySql(sql = "select SEQ_QCMS_DECISION_TREE_MODEL.nextval from dual", order = ORDER.BEFORE)
    private Long id;
    /**
     * 决策树模型名称
     */
