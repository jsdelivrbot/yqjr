    ...
    <div>
        <Form ref="teamReviewProEditData" :rules="ruleValidate" :model="teamReviewProEditData" :label-width="100">
            <Card>
                ...
                <Row>
                    <Col span="8" offset="2">
                        <FormItem label="生效时间：" hidden>
                            <DatePicker  v-model="teamReviewProEditData.startTime" style="width: 100%"></DatePicker>
                        </FormItem>
                    </Col>
                    <Col span="8" offset="2">
...
<script>
    ...
    export default{
        ...
        data () {
            ...
            const validateTeamAdress = (rule, value, callback) => {
                if (!isEmpty(value)) {
                    if (value.length > 60) {
