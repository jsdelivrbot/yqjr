        ...
        updateMenulist (state) {
            ...
            var textMenu = [
                ...
                {icon: 'ios-briefcase',
                    ...
                    title: '物料管理',
                    children: [
                        {icon: 'fireball', name: 'materialMaintenanceList', path: 'http://localhost:8081/#/materialMaintenanceList', title: '基本信息维护'},
                        {icon: 'fireball', name: 'materialAcceptanceList', path: 'http://localhost:8081/#/materialAcceptanceList', title: '物料验收'},
                        {icon: 'fireball', name: 'materialPutInStorageList', path: 'http://localhost:8081/#/materialPutInStorageList', title: '物料入库'},
                        {icon: 'fireball', name: 'materialPutOutStorageList', path: 'http://localhost:8081/#/materialPutOutStorageList', title: '物料出库'},
                        {icon: 'fireball', name: 'materialReviewList', path: 'http://localhost:8081/#/materialReviewList', title: '物料审核'},
                        {icon: 'fireball', name: 'materialReviewProgressList', path: 'http://localhost:8081/#/materialReviewProgressList', title: '物料审核进度处理'}]},
                {icon: 'ios-list',
                    name: 'matter',
                    path: '/matter',
                    title: '素材管理',
                    children: [
                        {icon: 'fireball', name: 'matterMaintenanceList', path: 'http://localhost:8081/#/matterMaintenanceList', title: '基本信息维护'},
                        {icon: 'fireball', name: 'matterLibraryList', path: 'http://localhost:8081/#/matterLibraryList', title: '素材库'},
                        {icon: 'fireball', name: 'matterPushRecordList', path: 'http://localhost:8081/#/matterPushRecordList', title: '素材推送记录'}]},
                {icon: 'fireball',
                    name: 'ddddd222',
                    path: '/work',
                    title: '促销活动管理demo',
