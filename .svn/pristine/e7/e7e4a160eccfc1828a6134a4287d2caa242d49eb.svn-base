...
<div class="main-container ace-save-state" id="main-container">
	...
	<div id="sidebar" class="sidebar responsive ace-save-state">
		...
		<script type="text/javascript">
			jQuery(function($) {
				$("#framework_menu_tree").frameworkMenu({url : "${basePath}/menu/list"});
				$(".nav-list a").click(function() {
					...
					if (url != '#') {
						...
						$("#breadCrumb").prepend("<li><i class=\"ace-icon fa fa-home home-icon\"></i> <a href=\"${uiPath}\">首页</a></li>");
						var $overlay = $('<div class="ajax-loading-overlay"><i class="ajax-loading-icon fa fa-spin fa-spinner fa-2x orange"></i></div>');
						//清楚menuTree选中样式
