                    ...
                    <Row>
                        ...
                        <Col span="8" offset="2">
                            <FormItem label="活 动 区 域:">
                                <Input v-model="formValidate.largeAreaName" style="width: 100%" placeholder="请输入区域名称"></Input>
                            </FormItem>
                        </Col>
                    </Row>
                    <Row>
                        ...
                        <Col span="8" offset="2">
                            <FormItem label="活动经销商:">
                                <Input v-model="formValidate.distributorName" placeholder="请输入经销商名称"/>
                            </FormItem>
                        </Col>
                    </Row>
                    <Row>
        ...
        methods: {
            ...
            exportExcel (name) {
                ...
                this.$refs[name].validate((valid) => {
                    if (valid) {
                        this.handleSearchDate(this.formValidate).then(res => {
                            var activeCode = this.formValidate.activeCode;
                            var largeAreaName = this.formValidate.largeAreaName;
                            var distributorName = this.formValidate.distributorName;
                            var brandsCode = this.formValidate.brandsCode;
                            var seriesCode = this.formValidate.seriesCode;
                            var carBrandType = this.formValidate.carBrandType;
                            window.location = '/mkmm/sales/activeMatchDetails/drownLoadDetail?activeCode=' + activeCode + '&largeAreaName=' + largeAreaName + '&distributorName=' + distributorName + '&brandsCode=' + brandsCode + '&seriesCode=' + seriesCode + '&carBrandType=' + carBrandType;
                        });
                    } else {
                        this.$Message.error('验证错误');
                    }
