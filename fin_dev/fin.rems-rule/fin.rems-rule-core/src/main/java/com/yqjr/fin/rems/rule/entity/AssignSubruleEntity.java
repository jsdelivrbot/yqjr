 ...
 * @description: 赋值型子规则
 * @author: lixue
 * @date: 2018/08/23 13:41:02
 **/
@EqualsAndHashCode(callSuper = true)
@Data
@Table(name = "REMS_ASSIGN_SUBRULE", schema = "REMS")
public class AssignSubruleEntity extends FinBaseMapperEntity<Long> {
   /**
    *主键id
    */
    @Id
    @KeySql(sql = "select SEQ_REMS_ASSIGN_SUBRULE.nextval from dual", order = ORDER.BEFORE)
    private Long id;
