 ...
 * @description: 金融专案轨迹
 * @author: lixue
 * @date: 2018/08/21 15:39:18
 **/
@EqualsAndHashCode(callSuper = true)
@Data
@Table(name = "FPMS_FINANCE_PROJECT_HIS", schema = "FPMS")
public class FinanceProjectHisEntity extends FinBaseMapperEntity<Long> {

    /**
     * 主键id
     */
    @Id
    @KeySql(sql = "select SEQ_FPMS_FINANCE_PROJECT_HIS.nextval from dual", order = ORDER.BEFORE)
    private Long id;
     ...
     * 贴息来源
     */
    @Column(name = "NWHO_PAY_DINTEREST", nullable = true, length = 50)
    @ColumnType(jdbcType = JdbcType.VARCHAR)
