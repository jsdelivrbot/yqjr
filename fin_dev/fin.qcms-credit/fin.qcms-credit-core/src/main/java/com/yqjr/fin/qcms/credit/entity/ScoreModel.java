...
@Data
@Table(name = "qcms_score_model", schema = "QCMS")
public class ScoreModel extends FinBaseMapperEntity<Long> {
     ...
     */
	@Id
	@KeySql(sql = "select SEQ_QCMS_SCORE_MODEL.nextval from dual", order = ORDER.BEFORE)
    private Long id;
    /**
     * 模型名称
     */
