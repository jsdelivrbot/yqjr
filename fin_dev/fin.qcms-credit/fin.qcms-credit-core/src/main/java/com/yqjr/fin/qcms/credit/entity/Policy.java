...
@Data
@Table(name = "qcms_policy", schema = "QCMS")
public class Policy extends FinBaseMapperEntity<Long> {
     ...
     */
	@Id
	@KeySql(sql = "select SEQ_QCMS_POLICY.nextval from dual", order = ORDER.BEFORE)
    private Long id;
    /**
     * 政策名称
     */
    ...
    /**
     * 政策子类型编码10 信贷政策 20 风险政策 30 利率政策
     */
	@ColumnType(jdbcType = JdbcType.BIGINT)
    private java.lang.Long policySubtypesCode;
    /**
     * 政策子类型名称10 信贷政策 20 风险政策 30 利率政策
     */
	@ColumnType(jdbcType = JdbcType.VARCHAR)
     ...
     */
	@ColumnType(jdbcType = JdbcType.TIMESTAMP)
    private java.util.Date expirarionDate;
    /**
     ...
     */
	@ColumnType(jdbcType = JdbcType.VARCHAR)
    private java.lang.String policyStatusName;
    /**
