...
public interface PersonPlanMapper extends Mapper<PersonPlan, Long> {
    ...
    //查一共有多少人人
    List<PersonPlan> selectPersonPlan(PersonPlanCondition personPlanCondition, PageBounds... pageBounds);

    //查一共有多少人人
    List<PersonPlan> selectPersonPlan(PersonPlanCondition personPlanCondition);

    //查每个人的12个月计划
    List<PersonPlan> selectPersonMonthPlan(PersonPlan personPlan);
