...
import com.yqjr.scfw.common.excel.annotation.DefaultAdapterMethod;
...
public class AdapterUtil {
    protected final static Class[] outputAdapterParms= new Class[]{DataBean.class,Object.class,String.class,Cell.class} ;
    protected final static Class[] inputAdapterParms= new Class[]{DataBean.class,Class.class,String.class,Cell.class} ;
    protected final static Class[] ValidateAdapterParms= new Class[]{DataBean.class,Sheet.class,int.class,String.class} ;
    public final static Class[] Constructor=new Class[]{DicCodePool.class};
     ...
     * @return
     */
    public static Method getInputAdapterMethod(Annotation clazz,Class adapter) throws Exception {
     ...
     * @return
     */
    public static Method getOutputAdapterMethod(Annotation clazz,Class adapter) throws Exception {
        String method=(String)Reflections.invokeMethod(clazz, "method", new Class[]{}, new Object[]{});
     ...
     * @return
     */
    public static Method getValidateAdapterMethod(Annotation clazz,Class adapter) throws Exception {
        String method=(String)Reflections.invokeMethod(clazz, "method", new Class[]{}, new Object[]{});
     ...
     * @return
     */
    public static boolean getInputDefaultByUp(Annotation clazz) throws Exception {
     ...
     * @return
     */
    public static boolean getNullAble(Annotation clazz) throws Exception {
     ...
     * @return
     */
    public static String getTipLangName(Annotation clazz) throws Exception {
        return (String)Reflections.invokeMethod(clazz, "tipLangName", new Class[]{}, new Object[]{});
    }

    public static boolean getAllMatch(Annotation clazz) throws Exception {
