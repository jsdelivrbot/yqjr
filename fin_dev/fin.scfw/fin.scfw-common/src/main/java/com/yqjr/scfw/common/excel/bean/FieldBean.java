...
public class FieldBean {
    ...
    public void setInputMethod(Class adapter) throws Exception {
    ...
    public void setOutputMethod(Class adapter) throws Exception {
        outputMethod= AdapterUtil.getOutputAdapterMethod(outputConfig,adapter);
        nullAble=AdapterUtil.getNullAble(outputConfig);
    }

    public void setValidateMethod(Class adapter) throws Exception {
